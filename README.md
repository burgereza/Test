...
<br>
<li>ابتدا از [اینجا](https://jasmine.github.io/) به وب سایت رسمی رفته و یکی از ورژن های آن را انتخاب کنید تا به صفحه آن منتقل شوید.</li>
<br>
...
برای مشاهده نتیجه اجرای تست ها ، کافی است فایل SpecRunner.html را اجرا کنید.
<br>
<br>
<h2>ایجاد تست کیس</h2>
...
هر Suite دو پارامتر دارد؛ پارامتر اول نام آن و پارامتر دوم مجموعه توابع تست آن (it) میباشد که به صورت زیر با describe و it ها تعریف میشوند:
...
که در مثال باال انتظار داریم مقدار تابع (5,5(add در فایل جاوااسکریپت مورد نظر میباشد، برابر با 10
شود؛ پس تست اول فیل و تست دوم پاس میشود. 

<br>

<h2>دیگر توابع expect:</h2>
